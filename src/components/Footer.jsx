...
const Footer = () => {
  return (
    ...
    <footer className="bg-neutral-primary  p-6">
    <div className="mx-auto w-full max-w-7xl flex justify-around items-center">
      <div className="grid grid-cols-2 gap-8 px-4 py-6 lg:py-8 md:grid-cols-4">
        <div>
            <h2 className="mb-6 text-sm font-semibold text-heading uppercase">Shoppe Store</h2>
            <ul className="text-body font-medium">
                ...
                <li className="mb-4">
                    <a href="#" className="hover:underline">Switch Light/Dark Mode</a>
                </li>
            </ul>
        </div>
        <div>
    ...
    <div className="px-2 py-2 bg-neutral-secondary-soft md:flex md:items-center md:justify-between">
        <span className="text-sm text-body sm:text-center">© 2023 <a href="https://flowbite.com/">Shoppe Shop™</a>. All Rights Reserved.
        </span>
